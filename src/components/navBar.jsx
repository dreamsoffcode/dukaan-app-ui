export function NavBar() {
  return (
    <div className="flex justify-between items-center border shadow mb-3 p-3 pl-8 bg-white">
      <Payouts />
      <SearchBox />
      <Icons />
    </div>
...
function Payouts() {
  return (
    <div className="flex items-center ">
      <div className="font-medium text-xl mr-2">Payouts</div>
      <div className="text-gray-700 flex items-center text-xs">
        ...
        <div className="ml-1">How it works</div>
      </div>
    </div>
  );
}
...
function SearchBox() {
  return (
    <div className="flex items-center p-2 border bg-gray-100 rounded-md">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
