        ...
        <div className="flex justify-between mb-4 flex-wrap">
            <div className="flex items-center p-2 border">
                ...
                <input
                    ...
                    className="outline-none bg-inherit ml-3"
                ></input>
            </div>
            <div className="flex items-center text-gray-500 font-normal">
                <div className="border flex items-center px-2 py-1 mr-4">
                    <div className="text-base text-black">Sort</div>
                    <svg
                        fill="#000000"
                        className="h-4 w-4 ml-2 text-gray-500 font-light"
                        version="1.1"
                        id="Capa_1"
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <table className="w-full table-auto overflow-x-scroll">
            <thead className="text-gray-600 text-sm text-left">
                <tr>
                    ...
                    <th className="font-medium p-3 text-right">ORDER AMOUNT</th>
                </tr>
            </thead>
                ...
                {transactions.map((trans, idx) => {
                    return (
                        <tr key={idx} className="border-b">
                            <td className=" text-sky-700 font-normal p-3 py-4 ">
                                {trans.OrderID}
                            </td>
                            <td className="p-3 py-4">
                                <Status status={trans.Status}></Status>
                            </td>
                            <td className="p-3 py-4">{trans.TransactionID}</td>
                            <td className="p-3 py-4">{trans.RefundDate}</td>
                            <td className="p-3 py-4 text-black font-normal text-right">
                                {trans.OrderAmount}
                            </td>
                        </tr>
                    );
